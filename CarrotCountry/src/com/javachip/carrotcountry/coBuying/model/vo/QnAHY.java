...
public class QnAHY {
	...
	public QnAHY(int gqNo, int postNo, String gqTitle, String memNo, Date gqEnrollDate, String gqContent) {
		super();
		this.gqNo = gqNo;
		this.postNo = postNo;
	...
	public QnAHY(int postNo, int gqNo, String memNo, String gqTitle, int gqViews, Date gqEnrollDate) {
		super();
		this.postNo = postNo;
		this.gqNo = gqNo;
		this.memNo = memNo;
	...
	public QnAHY(int gqNo, String gqTitle, String memNo, Date gqEnrollDate, String gqContent) {
		super();
		this.gqNo = gqNo;
		this.gqTitle = gqTitle;
		this.memNo = memNo;
	...
	public QnAHY(int gqNo, String memNo, String gqTitle, int gqViews, Date gqEnrollDate) {
		super();
		this.gqNo = gqNo;
		this.memNo = memNo;
		this.gqEnrollDate = gqEnrollDate;
	...
	public QnAHY(int gqNo, String memNo, int postNo, String gqContent, String gqAnswer, int gqViews, Date gqEnrollDate,
