...
public class LocationJY {
	...
	public LocationJY(int local_no, String local_si, String local_gu, String local_dong) {
		super();
	...
	public String toString() {
		return "LocationJY [local_no=" + local_no + ", local_si=" + local_si + ", local_gu=" + local_gu
				+ ", local_dong=" + local_dong + "]";
	}
