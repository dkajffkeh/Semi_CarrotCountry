 ...
 */
@WebServlet("/sortcategory30.pro.jy")
public class SortCategoryController30 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortCategoryController30() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> pList = new ProductService().sortCategory30(pi);
