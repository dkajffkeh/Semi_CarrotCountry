 ...
 */
@WebServlet("/sortcategory110.pro.jy")
public class SortCategoryController110 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortCategoryController110() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> pList = new ProductService().sortCategory110(pi);
