 ...
 */
@WebServlet("/sortcategory90.pro.jy")
public class SortCategoryController90 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortCategoryController90() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> pList = new ProductService().sortCategory90(pi);
