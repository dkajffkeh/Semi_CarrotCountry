 ...
 */
@WebServlet("/sortcategory40.pro.jy")
public class SortCategoryController40 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SortCategoryController40() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> pList = new ProductService().sortCategory40(pi);
