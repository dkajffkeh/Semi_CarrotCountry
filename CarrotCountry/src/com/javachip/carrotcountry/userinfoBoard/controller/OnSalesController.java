...
/**
 * Servlet implementation class OnSalesController
 */
@WebServlet("/onSale.me.jw")
public class OnSalesController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OnSalesController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("views/userinfoBoard/onSale.jsp");
