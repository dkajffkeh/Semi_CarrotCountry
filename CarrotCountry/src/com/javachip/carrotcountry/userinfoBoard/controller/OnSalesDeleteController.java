...
/**
 * Servlet implementation class OnSalesDeleteController
 */
@WebServlet("/onSalesDelete.jw")
public class OnSalesDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OnSalesDeleteController() {
        super();
