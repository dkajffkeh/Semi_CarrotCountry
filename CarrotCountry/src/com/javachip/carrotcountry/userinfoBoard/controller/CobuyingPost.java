...
/**
 * Servlet implementation class CobuyingPost
 */
@WebServlet("/coBuying.po.jw")
public class CobuyingPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/userinfoBoard/coBuyingPost.jsp").forward(request, response);;
