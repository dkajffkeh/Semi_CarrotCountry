...
/**
 * Servlet implementation class ShmarketUserSearchAjaxController
 */
@WebServlet("/shMarketUserSearch.sh.hy")
public class ShmarketUserSearchAjaxController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShmarketUserSearchAjaxController() {
        super();
...
response.setContentType("application/json; charset=utf-8");
		...
		String userDong = request.getParameter("userDo");
		String userCategory = request.getParameter("category");
		...
		ArrayList<PostBoard> bList = new TownMarketService().townMarketAjaxUserSearchMain(sp,userSearch,userGu,userDong,userCategory);
