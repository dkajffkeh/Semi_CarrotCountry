...
/**
 * Servlet implementation class TownMarketBoardAjaxMainCategoryController
 */
@WebServlet("/townMarketBoardSelectAjax.sh.hy")
public class TownMarketBoardAjaxMainCategoryController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TownMarketBoardAjaxMainCategoryController() {
        super();
