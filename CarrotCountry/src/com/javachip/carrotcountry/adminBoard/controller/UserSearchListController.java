...
/**
 * Servlet implementation class UserSearchListController
 */
@WebServlet("/userSearchList.sb")
public class UserSearchListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UserSearchListController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<AdminMember> list = new AdminMemberService().userSearchList(pi, category, search);
