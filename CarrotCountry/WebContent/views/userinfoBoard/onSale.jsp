		        ...
		        <!-- form태그 진행상태값 받아와야해서 넣음 -->
		            <table id="saleStatusTable">
		                <tr style="height:50px;">
		                    ...
		                    <th colspan="2" style=" text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>등록일</b></th>
		                </tr>
		     		...
		     		<input type="hidden" name="bno" value="<%= s.getPostNo() %>">
		                ...
		                <tr align="center">
		                    ...
		                    <td id="button1">
		                        <button type="submit" class="btn btn-primary btn-sm"data-toggle="modal" data-target="#updatePost<%= s.getPostNo() %>">판매완료</button>
		                        <button type="submit" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletePost<%= s.getPostNo() %>">삭제</button>
		                    </td>
		                </tr>
...
<!------------------------------------------------------------------------------------->
	...
	<!----------------------삭제버튼 클릭시 보여질 modal---------------------------------------->
	    ...
	    <!------------------------------------------------------------------------------------->
		<!----------------------판매완료 클릭시 보여질 modal---------------------------------------->
	 		<div class="modal" id="updatePost<%= s.getPostNo() %>">
			        <div class="modal-dialog">
			        <div class="modal-content">
